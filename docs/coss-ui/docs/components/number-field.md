...
For accessible labelling and validation, prefer using the `Field` component to wrap number fields. See the related example: [Number field](/docs/coss-ui/docs/components/field.md#number-field).
