...
For accessible labelling and validation, prefer using the `Field` component to wrap checkboxes. See the related example: [Slider field](/docs/coss-ui/docs/components/field.md#slider-field).
