...
For accessible labelling and validation, prefer using the `Field` component to wrap checkboxes. See the related example: [Switch field](/docs/coss-ui/docs/components/field.md#switch-field).
