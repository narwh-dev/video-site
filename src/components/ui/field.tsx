...
export function FieldLabel({
  ...
  return (
    <FieldPrimitive.Label
      className={cn(
        "inline-flex items-center gap-2 font-medium text-sm text-foreground data-disabled:opacity-50",
        className,
      )}
...
export function FieldError({
  ...
  return (
    <FieldPrimitive.Error
      className={cn("text-destructive-foreground text-[13px]", className)}
