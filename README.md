...
The MVP should stay focused on a full-stack application deployed to Cloudflare Workers through OpenNext, backed by Cloudflare-native services wherever practical.
...
- Auth.js user login with GitHub OAuth and Resend email magic links.
